...
# coq_makefile -R .  cech_nerve.v colimit.v epi_mono.v equivalence.v lemmas.v nat_lemmas.v sub_object_classifier.v univalence.v -o Makefile COQC = ../HoTT/hoqc COQDEP = ../HoTT/hoqdep 
#
